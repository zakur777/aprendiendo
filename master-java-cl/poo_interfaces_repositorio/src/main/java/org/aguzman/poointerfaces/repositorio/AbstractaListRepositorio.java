...
public abstract class AbstractaListRepositorio<T extends BaseEntity>
    implements OrdenablePaginableCrudRrepositorio<T> {
  ...
  public void crear(T t) throws EscrituraAccesoDatoException {
    if (t == null) {
      throw new EscrituraAccesoDatoException("Error al ingresar un objeto null");
    }
    if (this.dataSource.contains(t)) {
      throw new RegistroDuplicadoAccesoDatoException(
          "Error el objeto con id: " + t.getId() + " existe en el repositorio");
    }
